    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.inputView}>
          ...
          <Text style={styles.textSubparagraph}>(i) Email address</Text>
          <Text style={styles.textSubparagraph}>(ii) Preferred username</Text>
          <Text style={styles.textSubparagraph}>(iii) Password</Text>
          <Text style={styles.textSubparagraph}>(iv) Electric Vehicle Charging Preferences</Text>
          <Text style={styles.textParagraph}>
          ...
          <Text style={styles.textParagraph}>(a) As a Member, you agree to comply with the following:</Text>
          <Text style={styles.textSubparagraph}>
            (i) you will use the Services only for purposes that are permitted by:
          </Text>
          <Text style={styles.textIndent}>(A) the Terms; and</Text>
          ...
          <Text style={styles.textSubparagraph}>(i) use the Application pursuant to the Terms;</Text>
          <Text style={styles.textSubparagraph}>
          ...
          <Text style={styles.textParagraph}>(b) Subject to this clause, and to the extent permitted by law:</Text>
          <Text style={styles.textSubparagraph}>
          ...
          <Text style={styles.textParagraph}>(b) If you want to terminate the Terms, you may do so by:</Text>
          <Text style={styles.textParagraph}>
          ...
          <Text style={styles.textParagraph}>(c) Chameleon may at any time, terminate the Terms with you if:</Text>
          <Text style={styles.textParagraph}>
            (i) you have breached any provision of the Terms or intend to breach any provision;
          </Text>
          <Text style={styles.textParagraph}>(ii) Chameleon is required to do so by law;</Text>
          <Text style={styles.textParagraph}>
          ...
          <Text style={styles.textParagraph}>(iii) any breach of the Terms.</Text>
          ...
          <Text style={styles.textParagraph}>
            A party to the Terms claiming a dispute <Text style={styles.boldText}>(Dispute)</Text> has arisen under the
            Terms must give written notice to the other party detailing the nature of the dispute, the desired outcome,
          ...
          <Text style={styles.textParagraph}>
            On receipt of that notice <Text style={styles.boldText}>(Notice)</Text> by that other party, the parties to
            the Terms <Text style={styles.boldText}>(Parties)</Text> must:
          </Text>
          <Text style={styles.textParagraph}>
          ...
          <Text style={styles.textParagraph}>(iv) The mediation will be held in Melbourne, Australia.</Text>
          <Text style={styles.textParagraph}>
