    ...
    <SafeAreaView style={AboutStyle.container}>
      <ScrollView style={AboutStyle.scrollView}>
        <View style={AboutStyle.inputView}>
          ...
          <Text style={AboutStyle.sectionHeading}>2. Collection of personal information</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>3. How we collect your personal information</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>4. Use of your personal information</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>5. Disclosure of your personal information</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>6. Security of your personal information</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>7. Access to your personal information</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>8. Complaints about privacy</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>9. Opt out right</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>10. Changes to Privacy Policy</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.sectionHeading}>11. Software Application</Text>
          <Text style={AboutStyle.subSectionHeading}>(a) When you use our Application</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.subSectionHeading}>(b) Cookies</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.subSectionHeading}>(c) Automatic collection</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.subSectionHeading}>(d) Third parties</Text>
          <Text style={AboutStyle.textParagraph}>
          ...
          <Text style={AboutStyle.subSectionHeading}>(e) Geo-location</Text>
          <Text style={AboutStyle.textParagraph}>
